...
- דפי אודות, התחברות/הרשמה, תשלומים ורכישת מנוי
- התחברות משתמשים באמצעות אימייל וסיסמה או Google SSO
...
- `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET` - פרטי OAuth עבור התחברות Google SSO
- `GOOGLE_REDIRECT_URI` - כתובת callback מלאה ל-Google (אופציונלי; ברירת מחדל נגזרת מהשרת)
...
- `/about` - עמוד אודות
- `/login` - כניסה והרשמה
- `/payments` - תשלומים ורכישת מנוי
- `/subscribe` - כפתור/מסלול רכישת מנוי, כולל הפניה להתחברות אם צריך
